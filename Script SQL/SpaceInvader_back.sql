...
--
-- Hôte : db:3306
-- Généré le : mer. 18 déc. 2024 à 14:23
...
--
-- Base de données : `SpicyInvader`
--
DROP DATABASE IF EXISTS `SpicyInvader` ;
CREATE DATABASE `SpicyInvader` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `SpicyInvader`;
...
INSERT INTO `ARME` (`arme_id`, `type_arme`, `nom`, `description`, `prix`, `puissance`, `nb_coup`) VALUES
...
INSERT INTO `COMMANDE` (`cmd_id`, `date_cmd`, `joueur_id`) VALUES
...
INSERT INTO `CONTENIR` (`arme_id`, `cmd_id`, `quantité`) VALUES
('a001', 'c001', 1),
('a002', 'c002', 2),
('a003', 'c003', 3),
('a004', 'c004', 1),
...
INSERT INTO `JOUEUR` (`joueur_id`, `pseudo`, `xp`) VALUES
('1', 'aborrington0', '4490'),
('10', 'lyeardley9', '1365'),
('100', 'lspellward2r', '8593'),
('1011', 'andrewTate92i', '8593'),
('11', 'wbeebya', '8448'),
('12', 'kcarslawb', '5718'),
('13', 'eheinrichc', '3843'),
('14', 'baseld', '5975'),
...
INSERT INTO `POSSEDER` (`joueur_id`, `arme_id`, `nb_coup_restant`) VALUES
('1', 'a001', '95.00'),
('10', 'a010', '195.00'),
('11', 'a011', '125.00'),
('12', 'a012', '150.00'),
...
ALTER TABLE `CONTENIR`
  ADD PRIMARY KEY (`arme_id`,`cmd_id`),
...
ALTER TABLE `JOUEUR`
  ...
  ADD KEY `point_exp` (`xp`);

--
-- Index pour la table `POSSEDER`
--
ALTER TABLE `POSSEDER`
  ADD PRIMARY KEY (`joueur_id`,`arme_id`),
...
--
ALTER TABLE `COMMANDE`
  ADD CONSTRAINT `COMMANDE_ibfk_1` FOREIGN KEY (`joueur_id`) REFERENCES `JOUEUR` (`joueur_id`);

--
-- Contraintes pour la table `CONTENIR`
--
ALTER TABLE `CONTENIR`
  ADD CONSTRAINT `CONTENIR_ibfk_1` FOREIGN KEY (`arme_id`) REFERENCES `ARME` (`arme_id`),
  ADD CONSTRAINT `CONTENIR_ibfk_2` FOREIGN KEY (`cmd_id`) REFERENCES `COMMANDE` (`cmd_id`);

--
-- Contraintes pour la table `POSSEDER`
--
ALTER TABLE `POSSEDER`
  ADD CONSTRAINT `POSSEDER_ibfk_1` FOREIGN KEY (`joueur_id`) REFERENCES `JOUEUR` (`joueur_id`),
  ADD CONSTRAINT `POSSEDER_ibfk_2` FOREIGN KEY (`arme_id`) REFERENCES `ARME` (`arme_id`);
COMMIT;
